...
.PHONY: help install dev test lint format clean build deploy health docker-build docker-up docker-down up down restart logs
...
# =============================================================================
# DOCKER COMPOSE COMMANDS (New Unified Setup)
# =============================================================================
...
# Show logs for specific service (use pattern rule)
logs-%:
	docker compose logs -f $*
...
# Open shell in specific service (use pattern rule)
shell-%:
