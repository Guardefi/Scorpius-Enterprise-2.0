...
class ConfigManager:
    ...
    def _get_default_config(self):
        ...
        return {
            ...
            "REDIS_CONFIG": {"host": "localhost", "port": 6379, "db": 0},  # Example Redis config
                    ...
                    if isinstance(default_value, bool):
                        ...
                        if key == "RPC_URLS":
                            ...
                            self.config[key] = {
                                ...
                                "db": (
                                    int(os.getenv("REDIS_DB", "0")) if os.getenv("REDIS_DB") else 0
                                ),
    ...
    def save(self):
        ...
        save_config = {
            ...
            if k not in sensitive_keys and not k.endswith("_KEY") and not k.endswith("_SECRET")
        }
        try:
