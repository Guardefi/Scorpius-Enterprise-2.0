    ...
    def _validate_rust_opportunities(self, raw_ops: List[Dict]) -> List[Dict]:
        ...
        for op in raw_ops:
            try:
                ...
                loan_amount = (
                    float(loan_amount_str) if isinstance(loan_amount_str, str) else loan_amount_str
                )
    ...
    async def execute_opportunity(self, opportunity: MEVOpportunity) -> bool:
        ...
        try:
            ...
            if execution_success:
                ...
                self.stats.failed_executions += 1
                self.logger.warning(
                    f"❌ Sandwich attack failed - Target transaction escaped or gas war lost"
                )
...
class LiquidationBotStrategy(MEVStrategy):
    ...
    def __init__(self) -> None:
        ...
        self.monitored_assets = [
            ...
            {"symbol": "USDC", "address": "0xA0b86a33E6f8A7F56e8e0CC961134", "decimals": 6},
            {
                "symbol": "DAI",
