...
try:
    ...
    file_handler = logging.handlers.RotatingFileHandler(
        combined_log_path, maxBytes=LOG_MAX_BYTES, backupCount=LOG_BACKUP_COUNT, encoding="utf-8"
    )
    ...
    try:
        ...
        print(
            f"WARNING: Invalid FILE_LOG_LEVEL '{FILE_LEVEL}', defaulting to DEBUG.", file=sys.stderr
        )
