...
class MetricsCollector:
    ...
    def __init__(self, config: Optional[Dict[str, Any]] = None):
        ...
        self.prometheus_enabled = self.config.get('prometheus_enabled', True) and PROMETHEUS_AVAILABLE
...
class TimingContext:
    ...
    def __init__(self, metrics_collector: MetricsCollector, name: str, labels: Optional[Dict[str, str]] = None):
