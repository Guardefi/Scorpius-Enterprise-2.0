...
var evk__default = /*#__PURE__*/_interopDefaultLegacy(evk);
...
const visitor = Object.freeze(
    Object.assign(Object.create(null), {
        ...
        $visitChildren(node, options, visitorKeys) {
            ...
            for (const key of visitorKeys[type] || evk__default["default"].getKeys(node)) {
...
function hasSideEffect(
    ...
    return visitor.$visit(
        ...
        sourceCode.visitorKeys || evk__default["default"].KEYS,
    )
}
