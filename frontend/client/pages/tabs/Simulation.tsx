...
export default function Simulation() {
  ...
  const attackTypes: AttackType[] = [
    ...
    },
    {
      ...
      description: "Exploits voting mechanisms to gain unauthorized control",
      severity: "critical",
      complexity: "expert",
      icon: Shield,
      color: "text-red-700",
      estimatedTime: "5-15 min",
      requirements: ["Governance tokens", "Voting system", "Flash loans"],
    },
    {
      id: "bridge_exploit",
      name: "Bridge Exploit",
      description:
        "Attacks cross-chain bridges through signature validation flaws",
      severity: "critical",
      complexity: "expert",
      icon: Activity,
      color: "text-purple-700",
      estimatedTime: "10-30 min",
      requirements: ["Cross-chain bridge", "Validator keys", "Multi-sig"],
    },
  ];

  // Load simulation history on mount
  useEffect(() => {
    const savedHistory = StorageManager.getSimulationHistory();
  ...
  const runSimulation = async () => {
    ...
    try {
      ...
      // Generate mock result (in real app, this would call backend API)
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <Card className="cyber-card-enhanced">
            <CardHeader>
              <CardTitle className="flex items-center justify-between">
                <div className="flex items-center space-x-2 cyber-glow">
            ...
            <CardContent>
              ...
              <div className="mb-6 p-4 bg-cyber-cyan/5 rounded-lg border border-cyber-cyan/20">
                <Label className="text-sm font-medium mb-3 block text-cyber-cyan">
                  ...
                  >
                    ...
                    >
                      <CardHeader className="pb-3">
                        <div className="flex items-center justify-between">
                          <div className="flex items-center space-x-2">
                            ...
                            />
                            <CardTitle className="text-base font-semibold text-cyber-cyan">
                              {attack.name}
                            </CardTitle>
                          </div>
                          {selectedAttack === attack.id && (
                      ...
                      <CardContent className="space-y-3">
                        ...
                        <div className="flex items-center space-x-2 text-xs text-cyber-cyan/60">
                          <Clock className="h-3 w-3" />
                          <span>Est. Time: {attack.estimatedTime}</span>
                        </div>

                        <div className="space-y-2">
                          <p className="text-xs font-medium text-cyber-cyan/60">
                            Requirements:
                          </p>
                          <ul className="space-y-1">
                            {attack.requirements
                              ...
                              .map((req, reqIndex) => (
                                <li
                                  key={reqIndex}
                                  className="flex items-center text-xs text-cyber-cyan/60"
                                >
                            ...
                            {attack.requirements.length > 2 && (
                              <li className="text-xs text-cyber-cyan/60">
                        ...
                        {simulationResult.timeline.map((step, index) => (
                          ...
                          >
                            ...
                            <div className="flex-1">
                              <div className="font-medium text-cyber-cyan">
                                {step.step}
                              </div>
                              <div className="text-sm text-cyber-cyan/60">
                                {step.description}
                              </div>
                              <div className="text-xs text-cyber-cyan/40">
        ...
        <div className="space-y-6">
          ...
          <Card className="cyber-card-enhanced">
            ...
            <CardContent className="space-y-4">
              <div className="space-y-2">
                <Label className="text-cyber-cyan">Gas Limit</Label>
                <Input
                  ...
                  className="bg-black/70 border-cyber-cyan/30 text-white focus:border-cyber-cyan focus:ring-cyber-cyan/20"
                />
              </div>
              <div className="space-y-2">
                <Label className="text-cyber-cyan">Gas Price (Gwei)</Label>
                <Input
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="fork" className="text-cyber-cyan/80">
                  Fork mainnet state
                </Label>
              </div>
              <div className="flex items-center space-x-2">
                ...
                />
                <Label htmlFor="verbose" className="text-cyber-cyan/80">
                  Verbose logging
                </Label>
              </div>
            </CardContent>
          ...
          <Card className="cyber-card-enhanced">
            ...
            <CardContent>
              {simulationHistory.length === 0 ? (
                <p className="text-sm text-cyber-cyan/60 text-center py-4">
                ...
                <div className="space-y-3">
                  {simulationHistory.slice(0, 5).map((sim, index) => (
                    <div
                      key={index}
                      className="flex items-center justify-between p-3 bg-cyber-cyan/5 rounded-lg border border-cyber-cyan/20"
                    >
                      <div className="flex-1">
                        <div className="font-medium text-sm text-cyber-cyan">
                          {
